...
after :accounts, :activity_center, :audit_history, :calendar, :content, :content_builder, :geospatial, :hierarchy, :material_studio, :message_preview, :operator_chat, :social_graph, :tiny_mce, :workflow do
