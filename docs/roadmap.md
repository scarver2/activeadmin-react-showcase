...
16. **Image Editor & Annotation Studio** — nondestructive crop, rotation, flips, tonal filters, focal/region metadata, responsive pointer interaction, accessible controls, and Rails-enforced recipes over immutable Active Storage originals. See [Image Editor & Annotation Studio](image-annotation.md).
