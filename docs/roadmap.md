...
6. **File & Image Manager** — Active Storage-backed synthetic assets with authorized upload/delete/reset, bounded validation, previews, and meaningful Rails fallback. See [File & Image Manager](file-image-manager.md).
