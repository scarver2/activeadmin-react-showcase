...
ActiveAdmin.register_page "File Image Manager" do
  ...
  content title: "File & Image Manager" do
    assets = ShowcaseAsset.with_attached_file.order(:id)
    ...
    react_component(
      ...
      fallback: lambda {
        safe_join([
          content_tag(:p, "Assets remain downloadable and upload/delete remain ordinary Rails forms without JavaScript."),
          content_tag(:ul) do
