...
ActiveAdmin.register_page "Content Builder" do
  ...
  content title: "Rails-authoritative Content Builder" do
    document = current_admin_user.content_documents.includes(:content_blocks).order(:id).first
    ...
    if document
      ...
      panel("Demo data required") do
        para "No content-builder document exists for this administrator. Run bin/rails db:seed:content_builder to provision the deterministic synthetic fixture."
      end
    end
