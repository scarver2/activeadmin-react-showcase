...
module Showcase
  # Rails-owned vocabulary for searchable workspace destinations.
  class WorkspaceCatalog
    def self.groups
      routes = Rails.application.routes.url_helpers
      [
        { label: "Sales & Relationships", tools: [
        ...
        { label: "Production & Content", tools: [
        ...
        { label: "Collaboration & Reporting", tools: [
