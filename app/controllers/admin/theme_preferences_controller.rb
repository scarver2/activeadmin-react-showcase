  ...
  class ThemePreferencesController < ApplicationController
    ...
    def update
      ...
      respond_to do |format|
        ...
        format.html { redirect_back fallback_location: admin_root_path, notice: "Color palette updated." }
      end
      ...
      respond_to do |format|
        ...
        format.html { redirect_back fallback_location: admin_root_path, alert: "Color palette could not be updated." }
      end
    end
  end
end
